...
[CreateAssetMenu(fileName = "Wand", menuName = "CARDS/MINOR/Wand")]
public class Wand : Minor
{
    [SerializeField] int damage;
    public override void PlayCard(PlayerController player, EnemyController targetEnemy = null)
    {
        damage += BattleManager.Instance.WandExtraDamage;
        BattleManager.Instance.AddWandExtraDamage();
